...
/// The reorg tests that turn on candidate-set discovery and status-transition
/// guards (confirmed payments, restarts, survivors, closed invoices) - the
/// group the newest tests in this area tend to join.
mod survivors;
