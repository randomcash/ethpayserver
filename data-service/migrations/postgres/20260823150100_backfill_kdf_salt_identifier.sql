-- Pinned KDF salt identifier, 2 of 2: backfill. Separate file so the ALTER's
-- lock is already released; this runs at ROW EXCLUSIVE and does not block
-- reads.
--
...
-- account the unpinned derivation broke. Pinning `email` would freeze that
-- broken derivation forever;
